...
class RegisterPage(tk.Frame):       
    def __init__(self, parent, controller): 
        ...
        Entry1 = ttk.Entry(self, textvariable= email, width=10) # field entry for account E-Mail
        Entry1.grid(row=1, column=2)
        
        Entry2 = ttk.Entry(self, textvariable= name, width=10, show="*",validate="key") # Account Name
        ...
        Entry3 = ttk.Entry(self,variable= pin, width=10, show="*",validate="key") # PIN
        ...
        database.store_account(connection, name.get(), pin.get(), email.get())
      
        
        '''# Mimoona
        if Entry3 == Entry4:
            database.store_account(connection, Entry2, Entry3, Entry1)
        else:
